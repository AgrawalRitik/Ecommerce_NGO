...
export const productPhotoController = async(req,res)=>
{
  try{
    ...
    if(product.photo.data){
      ...
      // console.log('content',product.photo.data.contentType)
      // console.log('contentytpe',product.photo.data.length)
      // console.log('data',product.photo.data[0],product.photo.data[1],product.photo.data[2])
