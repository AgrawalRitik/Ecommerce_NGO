...
export const ProductDetails = () => {
   ...
   useEffect(()=>
   {
    ...
    {
        try{
              const {data} = await axios.get(`${process.env.REACT_APP_BASE_URL}/api/v1/product/get-product/${params.slug}`)
    ...
    {
        try{
            const {data} = await axios.get(`${process.env.REACT_APP_BASE_URL}/api/v1/product/related-product/${pid}/${cid}`)
