...
//   {
//     try{
//       const {data} = await axios.post(`${process.env.REACT_APP_BASE_URL}/api/v1/product/product-filters`,{checked,radio})
//        setProducts(data?.products)
//     }
//     catch(error)
//     {
...
//       res.status(500).send({
//         success:false,
//         message:"Something went wrong in Load more",
//         error
//       })
//     }
//   }
...
const HomePage = () => {
  ...
  return (
    <Layout title={"ALl Products - Best offers "}>
      ...
      {/* banner image */}
      <img
        src="images2\shoppingBanner.jpg"
        className="banner-img"
        alt="bannerimage"
        width={"100%"}
      />
